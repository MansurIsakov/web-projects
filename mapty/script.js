...
class Workout {
  ...
  _setDesciption() {
    ...
    } ${this.date.getDate()}`; // Getting 1) type 2) month 3) day
  }
...
class Running extends Workout {
  ...
  constructor(coords, distance, duration, cadence) {
    super(coords, distance, duration); // GONNA INHERIT FROM PARENT (WORKOUT)
    this.cadence = cadence;
    this.calcPace(); // CALCULATE PATHWAY
    this._setDesciption();
  }
...
class App {
  ...
  constructor() {
    ...
    form.addEventListener('submit', this._newWorkout.bind(this)); // DISPLAYING ON MAP
  ...
  // Moving to particular marker using ID
  _moveToPopup(e) {
